...
def compare_tamaki_heuristic_runtimes_treewidths():
    ...
    one_problem_graph_size, one_nodes, one_max_treewidth = read_peo_file("peo_bench_data/peo_tamaki_heuristic_heuristicRun1_maxNodes501_d3_p2_operators-diagonal_seed25.txt")
    two_problem_graph_size, two_nodes, two_max_treewidth = read_peo_file("peo_bench_data/peo_tamaki_heuristic_heuristicRun2_maxNodes501_d3_p2_operators-diagonal_seed25.txt")
    five_problem_graph_size, five_nodes, five_max_treewidth = read_peo_file("peo_bench_data/peo_tamaki_heuristic_heuristicRun5_maxNodes501_d3_p2_operators-diagonal_seed25.txt")
    fifteen_problem_graph_size, fifteen_nodes, fifteen_max_treewidth = read_peo_file("peo_bench_data/peo_tamaki_heuristic_heuristicRun15_maxNodes501_d3_p2_operators-diagonal_seed25.txt")
    ...
    plt.plot(one_problem_graph_size, one_max_treewidth, 'bo', two_problem_graph_size, two_max_treewidth, 'rs', five_problem_graph_size, five_max_treewidth, 'gh', fifteen_problem_graph_size, fifteen_max_treewidth, 'ys')
    plt.legend(["1 sec", "2 sec", "5 sec", "15 sec"])
...
def tw_reliance_connectivity():
    ...
    for d_i in d_values:
        _, _, tw = read_peo_file(
            "treewidth_dependency_data/peo_tamaki_heuristic_heuristicRun15_maxNodes21_d" + str(d_i) + "_p1_operators-diagonal_seed25.txt")
        p_1_max_treewidth.append(*tw)

    for d_i in d_values:
        _, _, tw = read_peo_file(
            "treewidth_dependency_data/peo_tamaki_heuristic_heuristicRun15_maxNodes21_d" + str(d_i) + "_p2_operators-diagonal_seed25.txt")
        p_2_max_treewidth.append(*tw)

    for d_i in d_values:
        _, _, tw = read_peo_file(
            "treewidth_dependency_data/peo_tamaki_heuristic_heuristicRun15_maxNodes21_d" + str(d_i) + "_p3_operators-diagonal_seed25.txt")
