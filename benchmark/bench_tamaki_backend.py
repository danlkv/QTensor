...
def plot_simulation_results():
    ...
    greedy_total_time = []
    greedy_peo = []
    with open("bench_tamaki_data/tamaki_bench_d5_p2.txt", "r") as file:
        for line in file:
            if line == "\n":
                continue
    ...
    with open("bench_tamaki_data/greedy_bench_d5_p2.txt", "r") as file:
        for line in file:
            if line == "\n":
                continue
            split_line = line.split(" ")
    ...
    plt.plot(tamaki_problem_graph_size, tamaki_max_treewidth, 'bo', greedy_problem_graph_size, greedy_max_treewidth, 'rs')
    plt.xticks(np.arange(2, 27, 2))
    ...
    # plt.ylabel('contr'
    #            'action runtime')
    # plt.plot(tamaki_problem_graph_size, tamaki_total_time, 'bo', greedy_problem_graph_size, greedy_total_time,
    #          'rs')
    # plt.xticks(np.arange(2, 27, 2))
    # # plt.yticks(np.arange(0, 17, 2))
    # plt.legend(["tamaki", "greedy"])
