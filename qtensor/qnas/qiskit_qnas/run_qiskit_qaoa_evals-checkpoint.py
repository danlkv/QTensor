...
def main(args):
    graphs, energies = get_graphs('QAOA_Dataset/20_10_node_erdos_renyi_graphs.txt',
    ...
    for i, g in enumerate(graphs):
        ...
        with mp.Pool(args.jobs) as pool:
            res = pool.starmap_async(par_fn, [(g, p, args) for _ in range(150)]) # generate a population of 150
            comp = res.get()
