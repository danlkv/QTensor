...
#PBS -k doe
# PBS -o ./stdout_${PBS_JOBID}.out
# PBS -e ./stderr_${PBS_JOBID}.out
...
mpiexec -n ${NTOTRANKS} --ppn ${NRANKS_PER_NODE} --depth=${NDEPTH} --cpu-bind depth  python /home/wberquis/repos/QTensor/qtensor/qnas/qiskit_qnas/run_qtensor_qaoa_evals.py
