...
from .CircuitComposer import QAOAComposer, OldQAOAComposer, ZZQAOAComposer, WeightedZZQAOAComposer, WarmStartQAOAComposer
...
class WarmStartQtreeQAOAComposer(WarmStartQAOAComposer):
    def _get_builder_class(self):
        return QtreeBuilder
